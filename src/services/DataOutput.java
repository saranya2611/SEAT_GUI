...
public class DataOutput {
     ...
     * @param studentList
     * @param outputFile
     * @throws IOException Outputs the the 'Effective Average Rank' and 'Credit Satisfaction Ratio' for each student
     */
     ...
     * @param studentList
     * @param outputFile
     * @throws IOException Outputs aggregate statistics like mean,variance,10 percentile of the 'Effective Average Rank' and 'Credit Satisfaction Ratio' for each student
     */
